...
export const UsersData = () => {
    ...
    return(
        ...
        <Table striped bordered hover> 
            ...
            <tbody>{users.map( ({id, username, email, address, role, roleName}) =>
                <UserRow key={id} id={id} username={username} email={email} address={address} roleName={roleName} role={role} refreshUsers={refreshUsers}/>)}
            </tbody>
        </Table>
    )
}
