...
export const Register = ({ setToken, originalPath }) => {
    ...
    return (
        ...
        <Form onSubmit={handleSubmit}>
            ...
            <Form.Control onChange={setEmail} value={email} type="text" placeholder="user@mail.com"/>
            <Form.Label>Address</Form.Label>
            <Form.Control onChange={setAddress} value={address} type="text" placeholder="address"/>
